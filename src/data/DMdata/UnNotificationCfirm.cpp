...
{
    // 方法实现用于生成插入数据库的SQL语句
    strData = "INSERT INTO \"" + modelName + "\".\"" + tableName + "\" (systemID, systemIP, mainCMD, subCMD, evidenceID, msgVersion, submittime, DataType, infoID, deleteNotify, deleteConfirmation, deleteConfirmationResponse, deleteNotificationConfirmationDiff, dataHash, datasign, randomidentification) VALUES ('" +
