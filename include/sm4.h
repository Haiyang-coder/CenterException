...
/**
 * \brief          SM4-CFB buffer encryption/decryption
 * \param ctx      SM4 context
 * \param mode     SM4_ENCRYPT or SM4_DECRYPT
 * \param length   length of the input data
 * \param iv       initialization vector (updated after use)
 ...
 * \param output   buffer holding the output data
 */
extern void sm4_crypt_cfb( sm4_context *ctx,
				   int mode,
				   unsigned int length,
				   unsigned char iv[16],
				   unsigned char *input,
 ...
 * \param output   buffer holding the output data
 */
extern void sm4_crypt_ctr( sm4_context *ctx,
                     int mode,
                     unsigned int length,
                     unsigned char iv[16],
                     unsigned char *input,
...
extern void sm4_crypt_gcm_ctr( sm4_context *ctx,
                    int mode,
                    unsigned int length,
                    unsigned char iv[16],
                    unsigned char *input,
...
extern void sm4_crypt_gcm_ctr_1r( sm4_context *ctx,
                    unsigned char iv[16],
                    unsigned char *output);
